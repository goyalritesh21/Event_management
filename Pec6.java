...
public class Pec6 extends javax.swing.JFrame {
Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    String club;
    /**
     * Creates new form Pec6
     */
    public Pec6(String club) {
        initComponents();
        this.club=club;
...
private void Update() {
        try {
            String sql = "select * from lecture_hall";
...
private void delete(){
    ...
    String sql="delete from lecture_hall where (to_date<? or Status='Rejected') and Club_Society=?";
...
private void Rejected(){
    try {
            String sql = "select * from lecture_hall where Status='Rejected' and Club_Society=?";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Venue: Lecture Hall");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(updateBooking, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CancelBooking, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void updateBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBookingActionPerformed
        try {
            ...
            String sql = "select * from lecture_hall where (Room_No=? and from_date=? and to_date=?) and Club_Society=?";
            ...
            else
            {
                ...
                {
                    String sql1="delete from lecture_hall where (Room_No=? and from_date=? and to_date=?) and Club_Society=?";
                    ...
                    Pec6Updation uf2 = new Pec6Updation("lecture_hall",fromDate,toDate,room,club);
                    uf2.setVisible(true);
        ...
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    Update();
                    JOptionPane.showMessageDialog(null, "Request for Lecture Hall L" +room+" booking for "+fromDate+" to "+toDate+" is successfull.");
                }
                else
                {
    ...
    private void CheckStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckStatusActionPerformed
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    JOptionPane.showMessageDialog(null,"Lecture Hall L"+room+" is available for booking");
                }
                else
                {
                    JOptionPane.showMessageDialog(null, "Lecture Hall L"+room+" is not available for booking");
                }
            }
        }
        catch (Exception e)
    ...
    private void CancelBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelBookingActionPerformed
        try{
            String sql2= "select * from lecture_hall where ( Room_No=? and from_date=? and to_date=?) and Club_Society=?";
            
            Connection conn2=PecConnector.ConnectorDb();
            PreparedStatement pst2=conn2.prepareStatement(sql2);
            ResultSet rs2=null;
            String sql="delete from lecture_hall where (Room_No=? and from_date=? and to_date=?) and Club_Society=?";
            pst=conn.prepareStatement(sql);
            String fromDate = ((JTextField) from_date.getDateEditor().getUiComponent()).getText()+" "+from_time.getValue().toString()+":"+from_time2.getValue().toString();
            String toDate = ((JTextField) to_date.getDateEditor().getUiComponent()).getText()+" "+to_time.getValue().toString()+":"+to_time2.getValue().toString();
            if(from_date.getDate()==null || to_date.getDate()==null)
    ...
    private void ViewBookingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewBookingsActionPerformed
        try {
            ...
            String sql = "select * from lecture_hall where Room_No=? and Club_Society=? and ((from_date>=? and to_date<=?) or(from_date<=? and to_date>=?) or (from_date<=? and to_date>=?))";
            pst = conn.prepareStatement(sql);
            String fromDate = ((JTextField) from_date.getDateEditor().getUiComponent()).getText()+" "+from_time.getValue().toString()+":"+from_time2.getValue().toString();
            String toDate = ((JTextField) to_date.getDateEditor().getUiComponent()).getText()+" "+to_time.getValue().toString()+":"+to_time2.getValue().toString();
            if(from_date.getDate()==null || to_date.getDate()==null)
...
//                    break;
            ...
            java.util.logging.Logger.getLogger(Pec6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
