 ...
 * @author ritesh
 */
public class Pec5Updation extends javax.swing.JFrame {
...
String club;
     ...
     */
    public Pec5Updation(String venue,String frDate,String tDate,String club) {
        initComponents();
        this.venue=venue;
        this.club=club;
        fromDate=frDate;
        ...
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    JOptionPane.showMessageDialog(null, "Request for Athletic Ground booking for "+fromDate1+" to "+toDate1+" is successfull.");
                    close();
                }
                else
                {
