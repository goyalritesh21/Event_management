 ...
 * @author ritesh
 */
public class Pec7Updation extends javax.swing.JFrame {
...
String club;
     ...
     */
    public Pec7Updation(String venue,String frDate,String tDate,int room,String club) {
        initComponents();
        this.venue=venue;
        this.club=club;
        fromDate=frDate;
        ...
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    JOptionPane.showMessageDialog(null, "Request for Tutorial Room T"+room+" booking for "+fromDate1+" to "+toDate1+" is successfull.");
                    close();
                }
                else
                {
