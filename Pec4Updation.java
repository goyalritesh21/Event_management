 ...
 * @author ritesh
 */
public class Pec4Updation extends javax.swing.JFrame {
...
String club;
     ...
     */
    public Pec4Updation(String venue,String frDate,String tDate,String club) {
        initComponents();
        this.venue=venue;
        this.club=club;
        fromDate=frDate;
        ...
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    JOptionPane.showMessageDialog(null, "Request for Football Ground booking for "+fromDate1+" to "+toDate1+" is successfull.");
                    close();
                }
                else
                {
