...
public class auditorium extends javax.swing.JFrame {
...
private void delete(){
    ...
    String sql="delete from auditorium where (to_date<? or Status='Rejected') and Club_Society=?";
...
private void Rejected(){
    try {
            String sql = "select * from auditorium where Status='Rejected' and Club_Society=?";
            pst = conn.prepareStatement(sql);
    ...
    private void initComponents() {
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(updateBooking, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CancelBooking, javax.swing.GroupLayout.PREFERRED_SIZE, 147, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jLabel1.setText("Venue: Auditorium");
    ...
    private void updateBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBookingActionPerformed
        try {
            ...
            String sql = "select * from auditorium where (from_date=? and to_date=?) and Club_Society=?";
            pst = conn.prepareStatement(sql);
            ...
            else
            {
                ...
                {
                    String sql1="delete from auditorium where (from_date=? and to_date=?) and Club_Society=?";
                    ...
                    UpdationForm uf2 = new UpdationForm("auditorium",fromDate,toDate,club);
                    uf2.setVisible(true); 
    ...
    private void CheckStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckStatusActionPerformed
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    JOptionPane.showMessageDialog(null, "Auditorium is available for booking");
                }
                else
                {
    ...
    private void CancelBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelBookingActionPerformed
        try{
            String sql2= "select * from auditorium where (from_date=? and to_date=? and Club_Society=?)";
            Connection conn2=PecConnector.ConnectorDb();
            PreparedStatement pst2=conn2.prepareStatement(sql2);
            ResultSet rs2=null;
            String sql="delete from auditorium where (from_date=? and to_date=? and Club_Society=?)";
            pst=conn.prepareStatement(sql);
            String fromDate = ((JTextField) from_date.getDateEditor().getUiComponent()).getText()+" "+from_time.getValue().toString()+":"+from_time2.getValue().toString();
            String toDate = ((JTextField) to_date.getDateEditor().getUiComponent()).getText()+" "+to_time.getValue().toString()+":"+to_time2.getValue().toString();
            if(from_date.getDate()==null || to_date.getDate()==null)
        ...
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    Update();
                    JOptionPane.showMessageDialog(null, "Request of Auditorium booking for "+fromDate+" to "+toDate+" is successfull.");
                }
                else
                {
                    JOptionPane.showMessageDialog(null, "Auditorium is not available for booking");
    ...
    private void ViewBookingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewBookingsActionPerformed
        try {
            String sql = "select * from auditorium where ((from_date>=? and to_date<=?) or(from_date<=? and to_date>=?) or (from_date<=? and to_date>=?))and Club_Society=?";
            pst = conn.prepareStatement(sql);
            String fromDate = ((JTextField) from_date.getDateEditor().getUiComponent()).getText()+" "+from_time.getValue().toString()+":"+from_time2.getValue().toString();
            String toDate = ((JTextField) to_date.getDateEditor().getUiComponent()).getText()+" "+to_time.getValue().toString()+":"+to_time2.getValue().toString();
            if(from_date.getDate()==null || to_date.getDate()==null)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(auditorium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new auditorium("EIC").setVisible(true);
//            }
//        });
    }
