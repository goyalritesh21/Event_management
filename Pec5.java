 ...
 * @author ritesh
 */
public class Pec5 extends javax.swing.JFrame {
Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    String club;
    /**
     * Creates new form Pec5
     */
    public Pec5(String club) {
        initComponents();
        this.club=club;
...
private void Update() {
        try {
            String sql = "select * from athletic_ground";
...
private void delete(){
    ...
    String sql="delete from athletic_ground where (to_date<? or Status='Rejected') and Club_Society=?";
...
private void Rejected(){
    try {
            String sql = "select * from athletic_ground where Status='Rejected' and Club_Society=?";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Venue: Athletic Ground");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(updateBooking, javax.swing.GroupLayout.PREFERRED_SIZE, 163, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void updateBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBookingActionPerformed
        try {
            ...
            String sql = "select * from athletic_ground where (from_date=? and to_date=?) and Club_Society=?";
            ...
            else
            {
                ...
                {
                    String sql1="delete from athletic_ground where (from_date=? and to_date=?) and Club_Society=?";
                    ...
                    Pec5Updation uf2 = new Pec5Updation("athletic_ground",fromDate,toDate,club);
                    uf2.setVisible(true);
    ...
    private void BookVenueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BookVenueActionPerformed
        try {
            String sql1 = "select * from athletic_ground where (from_date<=? and to_date>=?) and Club_Society=?";
            
            String sql2="insert into athletic_ground values (?,?,?,?)";
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    ...
                    pst.execute();
                    Update();
                    JOptionPane.showMessageDialog(null, "Request for Athletic Ground booking for "+fromDate+" to "+toDate+" is successfull.");
                }
                else
                {
                    JOptionPane.showMessageDialog(null, "Athletic Ground is not available for booking");
                }
            }
        }
        catch (Exception e)
    ...
    private void CheckStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckStatusActionPerformed
        try {
            ...
            else
            {
                ...
                if (!rs.next())
                {
                    JOptionPane.showMessageDialog(null, "Athletic Ground is available for booking");
                }
                else
                {
                    JOptionPane.showMessageDialog(null, "Athletic Ground is not available for booking");
    ...
    private void CancelBookingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CancelBookingActionPerformed
        try{
            String sql2= "select * from athletic_ground where (from_date=? and to_date=?) and Club_Society=?";
            
            Connection conn2=PecConnector.ConnectorDb();
            PreparedStatement pst2=conn2.prepareStatement(sql2);
            ResultSet rs2=null;
            String sql="delete from athletic_ground where (from_date=? and to_date=?) ";
            pst=conn.prepareStatement(sql);
            String fromDate = ((JTextField) from_date.getDateEditor().getUiComponent()).getText()+" "+from_time.getValue().toString()+":"+from_time2.getValue().toString();
            String toDate = ((JTextField) to_date.getDateEditor().getUiComponent()).getText()+" "+to_time.getValue().toString()+":"+to_time2.getValue().toString();
            if(from_date.getDate()==null || to_date.getDate()==null)
    ...
    private void ViewBookingsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewBookingsActionPerformed
        try {
            String sql = "select * from athletic_ground where ((from_date>=? and to_date<=?) or(from_date<=? and to_date>=?) or (from_date<=? and to_date>=?)) and Club_Society=?";
...
//                }
            ...
            java.util.logging.Logger.getLogger(Pec5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
